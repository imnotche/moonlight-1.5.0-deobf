...
extends Command {
    ...
    public void execute(String[] commands) {
        ...
        Module module = Moonlight.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Moonlight.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
        ...
        if (commands.length == 5 && (setting = module.getSettingByName(commands[2])) != null) {
            ...
            if (setting.getType().equalsIgnoreCase("String")) {
                ...
                ModuleCommand.sendMessage(String.valueOf(Formatting.DARK_GRAY) + module.getName() + " " + setting.getName() + " has been set to " + commands[3] + ".");
                return;
            }
            try {
            ...
            ModuleCommand.sendMessage(String.valueOf(Formatting.GRAY) + module.getName() + " " + setting.getName() + " has been set to " + commands[3] + ".");
        }
    }
}
